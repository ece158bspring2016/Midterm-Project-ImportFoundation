...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let parseConfiguration = ParseClientConfiguration(block: { (ParseMutableClientConfiguration) -> Void in
            ParseMutableClientConfiguration.applicationId = "NWCr9zLj2MLwKsXQyON7yEr5ebcFEi0q0DqeKsTv"
            ParseMutableClientConfiguration.clientKey = "Ndley4979ZWLQbgGokU0iggKRt152M21HiXLDMgW"
        ...
        // create new instance of CatsTableViewController
        ...
        // show a table view controller inside a navigation controller and put into
